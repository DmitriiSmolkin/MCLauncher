 ...
 *        MinecraftArguments need custom type adapter because it's represented as a string in this version's format.
 */
public class PreviousForgeVersion implements ForgeVersion {
